...
import { NavLink } from "react-router-dom";
import TargetCursor from "./TargetCursor";
// Poprawiłem ścieżkę, zakładając, że folder hooks jest w src, a Nav jest w src/components/PaintballMenu
import useMediaQuery from "./hooks/useMediaQuery";
import "./Nav.css";
...
const Nav = () => {
  ...
  return (
    // <<< KROK 2: Dodajemy event listenery do głównego kontenera nawigacji
    <nav
      className="navbar"
    ...
    >
      <div className="navbar-container">
        {/* <<< KROK 3: Zmieniamy warunek renderowania */}
